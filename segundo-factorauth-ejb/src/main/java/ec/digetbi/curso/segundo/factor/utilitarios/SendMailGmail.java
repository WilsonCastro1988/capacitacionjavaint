...
public class SendMailGmail {
    ...
    private String factorAutenticacion = "2FA-WILSON";
    ...
    public void enviarMail() {
        ...
        // message info
        String mailTo = user.getEmailUser();
        String subject = "INICIO DE SESI�N FIRMESA WEB";
        ...
        body.append(user.getNameUser() + "<br>");
        body.append("Inicio de sesión a Firmesa Web:<br><br>");
